...
class GroupsListWidgetSmall extends StatefulWidget {
  ...
  @override
  _GroupsListWidgetSmallState createState() => _GroupsListWidgetSmallState();
}

class _GroupsListWidgetSmallState extends State<GroupsListWidgetSmall> with TickerProviderStateMixin {
...
class GroupsView extends StatelessWidget {
  ...
  final Animation<double>? animation;
  final VoidCallback onScreenChange; // Add this line
  final textLimit = 20;
  ...
  const GroupsView({
    ...
    this.animation,
    required this.onScreenChange, // Add this line
  }) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  padding: const EdgeInsets.only(right: 1), // Sağ tarafa 10 birim padding
                                  child: Container(
                                    decoration: BoxDecoration(
